set_property SRC_FILE_INFO {cfile:D:/project_terminal-mainAAAAAAA/project_terminal-main/project_terminal/project_terminal.srcs/constrs_1/imports/constraints/Nexys-A7-100T-Master.xdc rfile:../../../project_terminal.srcs/constrs_1/imports/constraints/Nexys-A7-100T-Master.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { AN[5] }]; #IO_L23N_T3_A02_D18_14 Sch=an[7]
...
set_property -dict { PACKAGE_PIN C12    IOSTANDARD LVCMOS33 } [get_ports { reset_raw}]; #IO_L7P_T1_AD6P_35 Sch=uart_txd_in
