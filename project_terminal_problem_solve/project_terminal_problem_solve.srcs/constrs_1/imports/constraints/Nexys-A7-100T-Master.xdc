...
create_clock -add -name sys_clk_pin -period 50.00 -waveform {0 5} [get_ports {CLK100MHZ}];
##create_generated_clock -name CLK50MHZ -source [get_pins CLK50MHZ_reg/C] -divide_by 2 [get_pins CLK50MHZ_reg/Q]
##Switches
